...
extern const RPC_DISPATCH_TABLE DefaultIfName_v3_0_DispatchTable;
...
static const RPC_SERVER_INTERFACE DefaultIfName___RpcServerInterface =
    ...
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&DefaultIfName_v3_0_DispatchTable,
    0,
    0,
    0,
...
RPC_IF_HANDLE DefaultIfName_v3_0_s_ifspec = (RPC_IF_HANDLE)& DefaultIfName___RpcServerInterface;
...
static const RPC_DISPATCH_TABLE DefaultIfName_v3_0_DispatchTable = 
    {
    26,
...
static const RPC_DISPATCH_TABLE DefaultIfName_NDR64__v3_0_DispatchTable = 
    {
    26,
...
static const MIDL_SYNTAX_INFO DefaultIfName_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&DefaultIfName_NDR64__v3_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE DefaultIfName_ServerRoutineTable[] = 
    ...
    (SERVER_ROUTINE)Proc21,
    (SERVER_ROUTINE)Proc22,
    (SERVER_ROUTINE)Proc23,
    (SERVER_ROUTINE)Proc24,
    (SERVER_ROUTINE)Proc25
    };
